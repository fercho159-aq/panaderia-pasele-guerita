...
export const CartButton: React.FC = () => {
    ...
    return (
        <button 
            onClick={toggleCart}
            className="relative flex items-center gap-2 text-primary hover:text-accent transition-colors group"
        ...
        >
            ...
            <div className="relative">
                ...
                {itemCount > 0 && (
                    <span className="absolute -top-1 -right-1 bg-accent text-white text-[10px] font-black w-5 h-5 rounded-full flex items-center justify-center shadow-sm animate-fade-in">
                        {itemCount}
                    </span>
                )}
            </div>
